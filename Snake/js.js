...
const map = {
  ...
  render(snakePointsArray, foodPoint) {
    ...
    // Вместо ячейки еды foodCell была добавлена точка foodPoint.
...
/**
 * Счетчик игры.
 * @property {int} count Очки, сколько еды скушал пользователь.
 * @property {HTMLElement} countEl DOM-элемент, в который будут выводится очки.
 */
const score = {
  count: null,
  countEl: null,
