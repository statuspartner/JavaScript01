 ...
 * @property {string} settings.notFoundImageSrc Путь до картинки-заглушки.
 */
const gallery = {
  settings: {
    ...
    notFoundImageSrc: 'images/gallery/notFound.jpg',
  },
  ...
  containerClickHandler(event) {
    ...
    // Cоздали картинку. Если она есть, то покажи, если ошибка - открой картинку-заглушку.
    const img = document.createElement('IMG');
    img.onload = () => this.openImage(event.target.dataset.full_image_url);
    img.onerror = () => this.openImage(this.settings.notFoundImageSrc);
